...
// display all of the items that are for sale
...
connection.query('SELECT * FROM products', function(err, data) {
	...
	// prompt user: ID of the product they would like to buy

	inquirer.prompt([
		{
		type: "input",
		message: "What is the itemID of the product?",
		name: "id"
		}, {

			// prompt: how many of the product they would like to buy
			...
			//Check :enough to sell the user
			//if not respond to user "Insufficient quanitity" and prevent the order from going through
